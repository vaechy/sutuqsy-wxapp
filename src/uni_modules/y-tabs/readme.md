...
<table>
	...
	<tr><td> title-active-style    </td><td> object </td><td> 标题项选中样式  </td><td> - </td><td> 优先级 ：titleStyle > titleActiveSty	le > titleActiveColor </td></tr>
	<tr><td> title-inactive-style   </td><td> object </td><td> 标题项默认样式  </td><td> - </td><td> 优先级：titleStyle > titleInactiveStyle > titleInactiveColor </td></tr>
...
<u-popup :show="show" :round="10" @close="show = false" @open="open">
  <y-tabs ref="tabs" v-model="activeIndex">...</y-tabs>
</u-popup>
```
